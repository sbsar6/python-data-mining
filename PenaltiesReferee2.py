...
bar3 = Bar(penalties_meanHome,penalties_meanAway, title="Penalties and Scrums Awarded by Referee",palette=brewer["Blues"][3], stacked=True)
    
output_file("Referee Scrum Penalties.html")
show(bar3)
