...
def wrangle3(path):
    ...
    bar = Bar(ranks,features,title="Rankings",stacked=True)
...
def wrangle4(path):
    ...
    while count <= len(features):
        ...
        DictNumberFeatures[count] = (scores_SVM,scores_RF)
...
path = r"/home/david/Documents/Odesk/MachineLearningProjectPython/AllSeasonsCleaned.csv"
