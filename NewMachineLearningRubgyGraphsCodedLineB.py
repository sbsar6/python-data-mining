...
def wrangle3(path):
    ...
    List = ["Unnamed:_0","LineBreakPrevPhase", "PhaseName", "Tries", "Linebreak"]
    ...
    dictionary = {}
    for Label in Labels:
        dictionary[Label] = DataCSV[DataCSV["Linebreak"] == Label]
    
    bucket = DataCSV["Linebreak"].tolist()
    ...
    bar = Bar(ranks,features,title="Dragons Analyst Feature Rankings Linebreaks",palette=brewer["Purples"][3], stacked=True)
