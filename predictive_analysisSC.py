...
def data_prepare(fn, sel=["Clean Breaks","Defenders Beaten"], goal="Outcome", verbosity=0):
    ...
    all_columns = ['Kick at Goal Success', 'Drop Goals',
       'Kicks from Hand', 'Passes', 'Runs', 'Metres Run',
       'Possession(%)', 'Clean Breaks', 'Defenders Beaten', 'Offloads', 'Rucks Won', 'Mauls Won',
    ...
    all_names = ['Kick at Goal Success', 'Drop Goals',
       'Kicks from Hand', 'Passes', 'Runs', 'Metres Run',
       'Possession(%)', 'Clean Breaks', 'Defenders Beaten', 'Offloads', 'Rucks Won', 'Mauls Won',
        'Turnovers Conceded', 'Tackles Made', 'Tackles Missed',
       'Tackling Success Rate', 'Scrums on own feed', 'Lineouts on own feed', 'Penalties Conceeded',
...
def game_analysis(fn,sclf,ax=None,sel=["Clean Breaks","Defenders Beaten"],toest=False,verbosity=0):
...
def predict_evaluate_models(fn ,ax=None, sel=["Clean Breaks","Defenders Beaten"], goal="Outcome", verbosity=0):
    class_weight = 'auto'
