...
def feature_selection_ET(fn ,ax=None, sel="all", goal="Linebreak", verbosity=0, nf=7):
    n_estimators=500
    X, y, names = data_prepare(fn, sel=sel, goal=goal, verbosity=verbosity-1)
...
def feature_selection_RFE(fn ,ax=None, sel="all", goal="Linebreak", verbosity=0, nf=7):
    X, y, names = data_prepare(fn, sel=sel, goal=goal, verbosity=verbosity-1)
    if verbosity > 1:
