...
def https():
        for i in range (231903,232171,2):
            temp = ("http://en.espn.co.uk/premiership-2014-15/rugby/match/" + str(i)+".html?view=scorecard")
            urlList.append(temp)
        for i in range (8681,8945,2):
            temp = ("http://en.espn.co.uk/premiership-2013-14/rugby/match/18" + str(i)+".html?view=scorecard")
            urlList.append(temp)
        for i in range (166464,166598,1):
            temp = ("http://en.espn.co.uk/premiership-2012-13/rugby/match/" + str(i)+".html?view=scorecard")
            urlList.append(temp)
        for i in range (142486,142615,1):
            temp = ("http://en.espn.co.uk/premiership-2011-12/rugby/match/" + str(i)+".html?view=scorecard")
            urlList.append(temp)
        for i in range (118613,118747,1):
            temp = ("http://en.espn.co.uk/premiership-2010-11/rugby/match/" + str(i)+".html?view=scorecard")
            urlList.append(temp)
        for i in range (99164,99298,1):
            temp = ("http://en.espn.co.uk/premiership/rugby/match/" + str(i)+".html?view=scorecard")
            urlList.append(temp)
        for i in range (28141,28275,1):
            temp = ("http://en.espn.co.uk/premiership-2008-09/rugby/match/" + str(i)+".html?view=scorecard")
            urlList.append(temp)
        return urlList

https()
urlList = ["http://en.espn.co.uk/premiership-2012-13/rugby/match/166480.html?view=scorecard"]
